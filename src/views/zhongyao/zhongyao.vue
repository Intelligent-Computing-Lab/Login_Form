<template>
  <el-card>
    <el-row>
      <el-col :span="8">
        <el-input v-model="input" placeholder="请输入中药名" clearable @clear="getUserList">
    ...
    >
      <el-table-column prop="title" align="center" label="草药名称" width="300" />
      <el-table-column prop="content" align="center" label="草药描述">
...
export default {
  ...
  created() {
    axios.get('http://api.tianapi.com/zhongyao/index?key=7ddcf716a30672387708b5725268c79e&word=金银花')
      .then(res => {
        console.log(res)
